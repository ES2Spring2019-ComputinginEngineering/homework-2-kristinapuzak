...
# NUMBER OF HOURS TO COMPLETE: 1-2 (please track how long this homework takes you to complete).
# YOUR COLLABORATION STATEMENT(s) (refer to syllabus):
#I received assistance from Bo on this assignment
#*****************************************
...
def areaofatriangle(m1, b1, m2, b2, m3, b3):
    ...
    x3 = intersectionoftwolines_x(m3, b3, x1, b1)
    y3 = intersectionoftwolines_y(m3, b3, x1, b1)
